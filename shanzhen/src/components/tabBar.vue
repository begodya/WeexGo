<template>
  <div :class="['wrapper', isIpx&&isIpx()?'w-ipx':'']">
    ...
    <div class="bar-item" @click="tabTo('account')">
      <text class="bar-ic iconfont" :class="[this.isActive('account')]">&#xe639;</text>
      <text class="bar-txt" :class="[this.isActive('account')]">个人</text>
